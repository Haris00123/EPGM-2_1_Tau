...
class EPGM:
    ...
    This model is used to apply a second order Grays Model with a specialized Tau paraneter used to better model parameter behaviour
    '''
    ...
    def internal_predict(self, data, tau, coefficients, prediction_window, only_positive=True, clip=True, clip_value=2.0):
        '''
    ...
    def predict(self, prediction_window=10, only_positive=False):
        '''
        Predict future values using the fitted EPGM model.
        ...
        prediction = self.internal_predict(self.data, self.best_tau, self.params, prediction_window, only_positive)
